...
public class Tachometer extends JComponent implements KeyListener, Runnable{
    ...
    private double minor = 0.05;
    private String value = "0";
    private String unit = "X1000RPM";
...
//            int i =0;
//            if(result<1) {value="0";}
//            else if(result<2) {value="1";}
//            else if(result<3) {value="2";}
//            else if(result<4) {value="3";}
//            else if(result<5) {value="4";}
//            else if(result<6) {value="5";}
//            else if(result<7) {value="6";}
//            else if(result>2) {value="7";}
